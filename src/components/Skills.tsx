...
export function Skills() {
  ...
  return (
    <section id="skills" aria-label="Skills and expertise" className="py-20 px-4 sm:px-6 lg:px-8 bg-[rgb(var(--muted))]/30">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="max-w-3xl mx-auto text-[rgb(var(--muted-foreground))] leading-relaxed">
            A practical toolkit shaped by building projects end-to-end, from intelligent models and clean APIs to user-focused interfaces.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {skillCategories.map((category, catIndex) => (
            <motion.div
              ...
              className="glass-effect p-6 rounded-lg hover:shadow-xl transition-all duration-300 border-2 border-[rgb(var(--border))] hover:border-[rgb(var(--foreground))] overflow-hidden h-full"
            >
